...
function webfonts($custom_fontset, $is_ce) {
	...
	if($custom_fontset) {
		...
		$font_output .= '<style id="ce-fontset" type="text/css">';
		$font_output .= '.light,.light_italic{font-weight:300;}.regular,.regular_italic{font-weight:400;}.semibold,.semibold_italic{font-weight:600;}.bold,.bold_italic,strong,b{font-weight:700;}.custom_one,.custom_one_italic{font-family:"Libre Baskerville", Georgia, serif;font-weight:400;}';
