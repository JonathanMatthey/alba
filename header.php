...
<html <?php language_attributes(); ?>>
	<head>
		...
		<?php 
			...
			include('content-editor/webfonts.php'); webfonts($fontset_object, $is_ce); # include webfonts
	...
	<body <?php body_class(); ?>>
		<?php if(get_post_type($post->ID) === 'work') : ?>
		...
		<?php
			...
			if(isset($menu_style) && $menu_style === 'normal') {
				...
				// diplay menu
				$nav .= '<nav class="standard">' . wp_nav_menu( array( 'container' => '', 'theme_location' => 'main-menu',  'echo' => 0 ) ) . '</nav>';
			...
			if(isset($is_fluid) && $is_fluid === 'enabled') {
				...
				$navbar_html .= '<div class="logo fluid-logo fluid-' . $padding . '">';
				...
				$navbar_html .= '<div class="fluid-menu fluid-' . $padding . '-right">';
		...
		<div id="fullscreen-menu">
			<div class="menu-inner">
				<nav class="light <?php if(isset($menu_font_size)) { echo $menu_font_size; } ?>">
