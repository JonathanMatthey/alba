...
<div class="atts">
	<ul class="atts-save">
		<?php if($this->edit_mode !== 'single-edit') : ?>
			<li class="rem-atts"><a class="remove get-id" data-content-id="<?php echo $values['id']; ?>"></a></li>
		<?php endif; ?>
		<?php if($values['in_column'] && $this->edit_mode !== 'single-edit') : ?>
			<li><a class="up" data-content-id="<?php echo $values['id']; ?>"></a></li>
			<li><a class="down" data-content-id="<?php echo $values['id']; ?>"></a></li>
		<?php endif; ?>
		<?php if(!$values['in_column'] && $this->edit_mode !== 'single-edit') : ?>
			<li><a class="show-layers" data-content-id="<?php echo $values['id']; ?>"></a></li>
		<?php endif; ?>
		<?php
			// has bg color?
			$has_color = false;
		...
		?>
		<li><a class="color">BG Color</a></li>
		...
		<?php if(!$values['in_column'] && $this->edit_mode !== 'single-edit') : ?>
			<li class="save-align"><a class="save" data-content-id="<?php echo $this->id; ?>" data-content-type="<?php echo $this->content_type; ?>"></a></li>
		<?php elseif($this->edit_mode === 'single-edit') : ?>
			<li class="save-align"><a class="save-se" data-container-id="<?php echo str_replace('#', '', $this->ccId); ?>" data-content-id="<?php echo $this->id; ?>" data-content-type="<?php echo $this->content_type; ?>" data-column-id="<?php echo $this->column_id; ?>"></a></li>
		<?php endif; ?>
		<?php if(!$values['in_column'] && $this->edit_mode !== 'single-edit') : ?>
		<li class="layer-atts">
